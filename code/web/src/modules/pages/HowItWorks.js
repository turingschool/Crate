  ...
  <div>
    ...
    <Grid style={{ backgroundColor: grey }}>
      <GridCell style={{ padding: "2em", textAlign: "center" }}>
        ...
        <p style={{ marginTop: "1em", color: grey2 }}>
          Just 4 easy steps to subscribe and receive your monthly subscription
          of trendy clothes and accessories
        </p>
      </GridCell>
    </Grid>
    ...
    <Grid>
      ...
      >
        ...
        <H4 style={{ marginTop: "0.5em", textTransform: "uppercase" }}>
          Complete a style preferences survey
        </H4>

        <p style={{ marginTop: "0.5em", color: grey3 }}>
          Get recommendations tailored to your unique style.
        </p>
      </GridCell>
    </Grid>
    ...
    <Grid>
      ...
      >
        ...
        <p style={{ marginTop: "0.5em", color: grey3 }}>
          Choose one or multiple crates as per your need.
        </p>
      </GridCell>
